...
for L in [40]:#, 60, 80, 100, 120, 150]:
	for w_blk in [5.0]:#np.arange(4,7, 0.3):
		for w_bdry in [5.0]:#np.arange(0.8, 2, 0.2):
			for w_mixed in [w_blk]:#np.arange(10, 100, 20):
				...
				if L<=40: time_request = '00:20:00'
				elif L<=60: time_request='1:00:00'
				elif L<=100: time_request='4:00:00'
