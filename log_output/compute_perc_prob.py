...
def manager(npr, njobs):
    ...
    with open(run_dir+"width"+str(zone_width)+'perc_prob.pkl', 'wb') as handle:
        pickle.dump(completion_list, handle, protocol=pickle.HIGHEST_PROTOCOL)
